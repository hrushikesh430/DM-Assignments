...
int main()
{
    ...
    fw << "Column\\row , ,Bollywood ,, ,Tollywood ,, ,Total,,, " << endl;
    fw << ",Count, t - weight, d - weight, Count, t - weight, d - weight, Count, t - weight, d - wei ght " << endl;
                                                                                             for (auto r : rowMap)
    {
        row = r.first;
        fw << row << ",";
